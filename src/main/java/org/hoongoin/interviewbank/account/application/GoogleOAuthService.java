...
public class GoogleOAuthService {
    ...
    public Account googleLoginOrRegister(String authorizationCode) throws JsonProcessingException {
        ...
        ResponseEntity<String> tokenResponseJson = restTemplate.postForEntity(googleTokenUri, httpRequestEntity, String.class);
        ObjectMapper objectMapper = new ObjectMapper();
        objectMapper.setPropertyNamingStrategy(PropertyNamingStrategy.SNAKE_CASE);
        objectMapper.setSerializationInclusion(JsonInclude.Include.NON_NULL);
        GoogleTokenResponse googleTokenResponse = objectMapper.readValue(tokenResponseJson.getBody(), new TypeReference<GoogleTokenResponse>() {
        });
        ...
        GoogleUerInfo googleUerInfo = objectMapper.readValue(tokenResponseJson.getBody(), new TypeReference<GoogleUerInfo>() {
        });
